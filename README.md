...
```
## Result :
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/cc87f0f3-e769-4f0e-8929-f71917f05842" />

 
## Output  :


![WhatsApp Image 2025-11-14 at 08 45 30_5c3082e1](https://github.com/user-attachments/assets/bf9ae6a0-1c86-442b-b40f-c290bdb82ccb)

## Result:
The ADC channel was successfully configured to interface an analog sensor and convert its output into digital values. These converted readings were transmitted through UART and correctly displayed on the COM port.
